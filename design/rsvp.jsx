...
// success state. Stores submission in localStorage so a refresh remembers
// they RSVP'd (the user can swap this for a real backend on deploy).
...
function RSVP() {
  ...
  const submit = (e) => {
    ...
    const record = { ...form, at: new Date().toISOString() };
