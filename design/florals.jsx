...
const Leaf = ({ className = "", style = {}, flip = false }) => (
...
const Sprig = ({ className = "", style = {}, flip = false }) => (
...
const Fern = ({ className = "", style = {}, flip = false }) => (
...
const Daisy = ({ className = "", style = {}, color = "currentColor",
...
const Branch = ({ className = "", style = {}, flip = false }) => (
...
const CornerOrnament = ({ className = "", style = {}, flip = false, flipY = false }) => (
...
const MiniSprig = ({ className = "", style = {}, flip = false }) => (
...
const Petal = ({ className = "", style = {}, color = "var(--c-blush)" }) => (
...
Object.assign(window, {
  Leaf, Sprig, Fern, Daisy, Anemone, Branch,
  Divider, CornerOrnament, MiniSprig, Petal,
});
